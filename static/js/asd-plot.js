...
(function() {
  var Plot, averageAmplitudes, console, d3, describe, dualPlot, isEmpty, mergeObj, ratioPlot, refreshTime, updateLatestFrame, updateShortAverage;
  ...
  Plot = (function() {
    ...
    Plot.prototype.makeLine = function() {
      var accessX, accessY, mapX, mapY, _ref, _ref1;
      ...
      if (this.defined != null) {
        return this.line.defined(this.defined);
      }
    };
  ...
  dualPlot.setDefined(function(d) {
    return d[0] !== 0 && !isNaN(d[1]);
  });
  ...
  ratioPlot.setDefined(function(d) {
    return d[0] !== 0 && !isNaN(d[1]);
  });

  refreshTime = 500;

  updateLatestFrame = function() {
    return d3.json("asd/frames/latest", function(error, json) {
      var amplitudes, data, frequencies, i, time, _ref;
      ...
      _ref = json.data, time = _ref.time, frequencies = _ref.frequencies, amplitudes = _ref.amplitudes;
      data = (function() {
      ...
      return setTimeout(updateLatestFrame, refreshTime);
    });
  };
  ...
  d3.json("asd/averages/0.01", function(error, json) {
    var amplitudes, data, frequencies, i, _ref;

    if ((error != null) || !json.success) {
      console.log(error);
      return;
    }
    _ref = json.data, frequencies = _ref.frequencies, amplitudes = _ref.amplitudes;
    data = (function() {
      var _i, _ref1, _results;
    ...
    return averageAmplitudes = amplitudes;
  });

  updateShortAverage = function() {
    return d3.json("asd/averages/0.1", function(error, json) {
      var amplitudes, frequencies, i, ratioData, _ref;
      ...
      _ref = json.data, frequencies = _ref.frequencies, amplitudes = _ref.amplitudes;
      if (averageAmplitudes != null) {
        ratioData = (function() {
          var _i, _ref1, _results;

          _results = [];
          for (i = _i = 0, _ref1 = frequencies.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
            _results.push([frequencies[i], amplitudes[i] / averageAmplitudes[i]]);
          }
          return _results;
        })();
        ratioPlot.draw("ratio", ratioData);
      }
      return setTimeout(updateShortAverage, refreshTime);
    });
  };
